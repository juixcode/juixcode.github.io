...
[[
    ...
    [
        ...
        "[👥] Chi pensi sia il più simpatico?",
        "[☝️] Mostraci il tuo miglior ballo imbarazzante per 10s",
        "[☝️] Siediti sul pavimento fino al prossimo turno"
    ],[
        "[❓] Una qualità indispensabile per essere il vostro/la vostra partner?",
        "[❓] Una qualità indispensabile per essere il tuo/la tua compagno/a?",
        ...
        "[❓] Potresti tornare insieme a qualcuno dei tuoi ex?",
        ...
        "[☝️] Abbracciare qualcuno che si desidera veramente",
        "[☝️] Rivela una particolarità fisica"
    ],[
        "[❓] Un feticcio?",
        "[❓] Il luogo in cui sognate di fare l'amore",
        ...
        "[❓] Essere dominati, ti farebbe diventare kiffer?",
        ...
        "[❓] Classe di preferenza: sesso vaginale; orale; anale",
        ...
        "Dormire con la persona più lontana da te o fare un'orgia tutti insieme?",
        "[👥] Con chi non andresti assolutamente a letto?",
        "[👥] Dormire con due persone a tua scelta o niente?",
